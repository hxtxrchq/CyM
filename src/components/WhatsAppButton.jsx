        ...
        <AnimatePresence>
          {showHint && (
            <motion.div
              ...
              className="pointer-events-none absolute right-full top-1/2 mr-3 w-[min(240px,calc(100vw-6.5rem))] -translate-y-1/2 rounded-2xl border border-[#8D9571]/35 bg-[#F5F1E8] px-4 py-3 text-[13px] leading-5 text-[#2F352B] shadow-[0_12px_28px_rgba(0,0,0,0.14)]"
            >
